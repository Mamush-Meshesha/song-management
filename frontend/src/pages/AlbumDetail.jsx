...
import { fetchSongByAlbumRequest, setSelectedSongUrl, setShowPlayer, setShowUpdate } from "../slice/songSlice";
...
const AlbumDetail = () => {
  ...
  const [isHovered, setIsHovered] = useState(new Array(album).fill(false));
  ...
  useEffect(() => {
    ...
    const handleMouseEnter = (index) => {
      const newIsHovered = new Array(album.length).fill(false);
